...
<body>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          //      <li><a href="#">Home</a></li>
                <li class="active"><a href="Analysis4.php">Home</a></li>
...
$query = "select batch.batch_id, batch.sub_id,batch.students,subject.fees from batch join subject on batch.sub_id=subject.sub_id";//You don't need a ; like you do in SQL
...
echo "<tr><td>" . $row['batch_id'] . "</td><td >" . $row['sub_id'] ."</td><td >" . $row['fees'] . "</td></tr>";  //$row['index'] the index here is a field name
}
