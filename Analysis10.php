...
<body>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          //      <li><a href="#">Home</a></li>
                <li class="active"><a href="Analysis10.php">Home</a></li>
...
$query = "SELECT FAC_NAME AS 'Faculty', stu_name as 'Student' from (select a.stu_id, a.stu_name, b.batch_id, c.fac_id, d.fac_name from 
students a, student_batch_info b, batch c , faculty d where a.stu_id = b.stu_id and b.batch_id = c.batch_id and c.fac_id = d.fac_id 
and nationality = 'SPANISH')as student where fac_name = 'PROF. CHRIS'";//You don't need a ; like you do in SQL
...
echo "<tr><td>" . $row['Faculty'] . "</td><td >" . $row['Student'] ."</td></tr>";  //$row['index'] the index here is a field name
}
