...
<body>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          //      <li><a href="#">Home</a></li>
                <li class="active"><a href="Analysis5.php">Home</a></li>
...
$query = "select fac_name as 'Faculty',count(stu_id) as 'No. of Students' ,degree as 'Students Major' from (select a.stu_id , a.degree , 
b.batch_id , d.fac_name from students a, student_batch_info b, batch c, faculty d where a.stu_id = b.stu_id and b.batch_id = 
c.batch_id and c.fac_id = d.fac_id) as prof_count group by fac_name,degree;";//You don't need a ; like you do in SQL
...
echo "<tr><td>" . $row['Faculty'] . "</td><td >" . $row['No. of Students'] ."</td><td >" . $row['Students Major'] . "</td></tr>";  //$row['index'] the index here is a field name
}
