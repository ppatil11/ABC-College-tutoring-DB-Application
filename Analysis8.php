...
<body>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          //      <li><a href="#">Home</a></li>
                <li class="active"><a href="Analysis8.php">Home</a></li>
...
$query = "select branch_id as 'Branch', sum(fees) as 'Income' from (select s.stu_id,sbi.batch_id,b.sub_id,sub.fees, cbi.branch_id from 
students s join student_batch_info sbi on s.stu_id=sbi.stu_id join batch b on sbi.batch_id=b.batch_id join subject sub on 
b.sub_id=sub.sub_id join campus_batch_info cbi on sbi.batch_id = cbi.batch_id) as fees group by branch_id";//You don't need a ; like you do in SQL
...
echo "<tr><td>" . $row['Branch'] . "</td><td >" . $row['Income'] ."</td></tr>";  //$row['index'] the index here is a field name
}
