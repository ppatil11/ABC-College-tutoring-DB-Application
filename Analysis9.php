...
<body>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          //      <li><a href="#">Home</a></li>
                <li class="active"><a href="Analysis9.php">Home</a></li>
...
$query = "select branch_id as 'Branch', sum(salary) as 'Expenditure' from (select f.fac_id, f.salary , bat.batch_id, cbi.branch_id from 
faculty f join batch bat on f.fac_id = bat.fac_id join campus_batch_info cbi on bat.batch_id = cbi.batch_id) as fees group by 
branch_id";//You don't need a ; like you do in SQL
...
echo "<tr><td>" . $row['Branch'] . "</td><td >" . $row['Expenditure'] ."</td></tr>";  //$row['index'] the index here is a field name
}
