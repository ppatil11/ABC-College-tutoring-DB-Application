...
<body>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          //      <li><a href="#">Home</a></li>
                <li class="active"><a href="Analysis1.php">Home</a></li>
...
$query = "select branch_id, sum(students) as 'Total Students' from (select a.Branch_id , b.batch_id , c.students

from branch a, campus_batch_info b , batch c where a.branch_id = b.branch_id 
                                               and b.batch_id = c.batch_id
                                               and a.address = 'King Drive') as student_count group by branch_id";//You don't need a ; like you do in SQL
...
echo "<tr><td>" . $row['branch_id'] . "</td><td >" . $row['Total Students'] . "</td></tr>";  //$row['index'] the index here is a field name
}
