...
<body>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          //      <li><a href="#">Home</a></li>
                <li class="active"><a href="Analysis3.php">Home</a></li>
...
$query = "select batch.batch_id,batch.timing,CAMPUS_BATCH_INFO.branch_id from batch join CAMPUS_BATCH_INFO on 
batch.batch_id=CAMPUS_BATCH_INFO.branch_id";//You don't need a ; like you do in SQL
...
echo "<tr><td>" . $row['batch_id'] . "</td><td >" . $row['timing'] . "</td></tr>";  //$row['index'] the index here is a field name
}
