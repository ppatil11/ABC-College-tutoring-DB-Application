...
<body>
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          //      <li><a href="#">Home</a></li>
                <li class="active"><a href="Analysis2.php">Home</a></li>
...
$query = "select branch_id, round(avg(students)) as 'Avg Students' from (select a.Branch_id , b.batch_id , c.students from branch a, 
campus_batch_info b , batch c where a.branch_id = b.branch_id and b.batch_id = c.batch_id ) as student_count group by branch_id
...
echo "<tr><td>" . $row['branch_id'] . "</td><td >" . $row['Avg Students'] . "</td></tr>";  //$row['index'] the index here is a field name
}
