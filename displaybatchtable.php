...
$query = "SELECT * from BATCH";//You don't need a ; like you do in SQL
...
echo "<tr><td>" . $row['BATCH_ID'] . "</td><td >" . $row['TIMING'] . "</td><td >" . $row['SUB_ID'] . "</td><td >" . $row['FAC_ID'] . "</td><td >" . $row['STUDENTS'] ."</td></tr>";  //$row['index'] the index here is a field name
}
